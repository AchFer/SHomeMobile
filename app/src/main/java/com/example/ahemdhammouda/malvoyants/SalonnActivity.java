...
public class SalonnActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = SalonnActivity.class.getSimpleName();
    private SQLiteHandlernoeud db1;
    private SessionManager session;
    private ProgressDialog pDialog;
    AlertDialog.Builder builder;
    TextView temp, gaz, lum, objet, couleur;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db1 = new SQLiteHandlernoeud(getApplicationContext());
    ...
    public void repeat(){
       ...
       temp.setText(shaaa.getString("temperature",""));
        ...
        lum.setText(shaaa.getString("luminosite",""));
        objet.setText(shaaa.getString("tag",""));
        couleur.setText(shaaa.getString("couleur",""));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent i = new Intent(SalonnActivity.this, LoginActivity.class);
            startActivity(i);
            return true;
        }
    ...
    public List getNodeValues() {
        String server_url = GlobalUrl.url2 + "/getnode/" + getIntent().getStringExtra("sal");
        final SharedPreferences sha = getSharedPreferences("salonvalue", MODE_PRIVATE);
        final SharedPreferences.Editor edi = sha.edit();
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        while (count < response.length()) {
                            try {
                                ...
                                if (jsonObject2.getString("nomCapteur").contains("tag ref ")) {
                                    ...
                                    edi.putString("tag", jsonObject.getString("content"));
                                    edi.apply();
                                ...
                                if (jsonObject2.getString("nomCapteur").contains("couleur")) {
                                    ...
                                    edi.putString("couleur", jsonObject.getString("content"));
                                    edi.apply();
                                ...
                                if (jsonObject2.getString("nomCapteur").contains("lumonisité")) {
                                    ...
                                    edi.putString("luminosite", jsonObject.getString("content"));
                                    edi.apply();
                                ...
                                if (jsonObject2.getString("nomCapteur").contains("humidity")) {
                                    ...
                                    edi.putString("humidity", jsonObject.getString("content"));
                                    edi.apply();
                                ...
                                if (jsonObject2.getString("nomCapteur").contains("temperature")) {
                                    ...
                                    edi.putString("temperature", jsonObject.getString("content"));
                                    edi.apply();
                                ...
                                if (jsonObject2.getString("nomCapteur").contains("gaz")) {
                                    ...
                                    edi.putString("gaz", jsonObject.getString("content"));
                                    edi.apply();
                                ...
                                if (jsonObject2.getString("nomCapteur").contains("flame")) {
                                    ...
                                    edi.putString("flame", jsonObject.getString("content"));
                                    edi.apply();
                        ...
                        Log.e("aaaaaaaaaaaaa", "les valeursrrrrrrrrrrrrrrrrrr :  " + "temp = " + sha.getString("temperature", "") + "gaz = " + sha.getString("gaz", "") + "lum =" + sha.getString("luminosite", "") + "hum=" + sha.getString("humidity", "") + "tga=" + sha.getString("tag", "") + "col=" + sha.getString("couleur", "") + "fla=" + sha.getString("flame", ""));
        ...
        MySegleton.getmInstance(SalonnActivity.this).addTorequestque(jsonArrayRequest);
    ...
    public void sendrec ()
    {
        ...
        String server_url = GlobalUrl.url + "/adreclamation/" + iduser + "/" + "Salon problem" + "/" + "Problem detected in living room" + "";
        ...
        MySegleton.getmInstance(SalonnActivity.this).addTorequestque(stringRequest);
